...
QT_MOC_LITERAL(4, 30, 11) // "dataToImage"

    },
    "ImageProcess\0showImage\0\0image\0dataToImage"
};
...
void ImageProcess::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->showImage((*reinterpret_cast< QPixmap(*)>(_a[1]))); break;
        case 1: _t->dataToImage(); break;
        default: ;
        }
        ...
        {
            typedef void (ImageProcess::*_t)(QPixmap );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ImageProcess::showImage)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void ImageProcess::showImage(QPixmap _t1)
{
