...
QT_MOC_LITERAL(8, 42, 12) // "sendPointPos"

    },
    "EventLabel\0drawLine\0\0lineType\0x1\0y1\0"
    "x2\0y2\0sendPointPos"
};
...
void EventLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->sendPointPos((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            typedef void (EventLabel::*_t)(int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&EventLabel::sendPointPos)) {
                *result = 1;
            }
        }
    }
...
// SIGNAL 1
void EventLabel::sendPointPos(int _t1, int _t2)
{
